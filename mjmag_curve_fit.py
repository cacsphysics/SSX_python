...
"""
#--------------------------------------
def sine_data1(bAvg, pos, amp, waveNum, phase, title):
...
"""
#--------------------------------------
def sine_data2(bAvg, pos, amp, waveNum, phase, shift, title):
...
"""
#--------------------------------------
def data_interval(istep, fstep, spoint, epoint):
...
"""
bAvg, pos, title = data_interval(2400,2500,5,15)
...
xo = np.array([200.0, 2*m.pi/4.0, 0.0])
#--------------------------------------
...
sine_data1(bAvg, pos, vari[0], vari[1], vari[2], title)